...
/// <summary>
///     Base class for repositories that provide data access operations for entities.
/// </summary>
    ...
    where TKey : IEquatable<TKey>
{
    ...
    {
        return GetQuery().First(EntityHelper.CreateEqualityExpressionForId<TEntity, TKey>(id));
    }
